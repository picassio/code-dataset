...
class GoogleOAuthLM(BaseLM):
    ...
    def _get_credentials(self) -> tuple[str, str]:
        ...
        if not result:
            raise ValueError("No Google OAuth credentials found. Run 'code-dataset auth login google' to authenticate.")
    ...
    def __call__(
        ...
        **kwargs,
        ...
        if system_instruction:
            inner_request["systemInstruction"] = {"parts": [{"text": system_instruction}]}
